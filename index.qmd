...
* `create_project("../project0")`

* `renv::init()` then :eyes: look :eyes:

* `renv::install("maelle/coolcool")`

* `use_r("blop")`, write `coolcool::my_best_function()`
...
* In another folder `create_from_github("maelle/project0")`
...
renv works without RStudio too!

It is well supported in RStudio, for instance when creating a new project from the menu.
